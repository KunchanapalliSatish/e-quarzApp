...
public class Searchdrop_Functionality extends Testbase {
	...
	public void dropdown() throws Throwable {
		...
		for (WebElement dyn : dynamic) {
			Thread.sleep(3000);
			if (dyn.getText()
					.equals("HP Laptop 14s, 12th Gen Intel Core i3-1215U, 14-inch (35.6 cm), FHD, 8GB DDR4, 5")) {
				dyn.click();
				String str1 = driver.getCurrentUrl();
				assertEquals(
						"http://e-quarz.com/product/hp-14s-12th-gen-intel-core-i5-16gb-ram512gb-ssd-14-inch356-cm-micro-edge-fhd-laptopintel-iris-xe-graphicsalexadual-speak",
						str1);
			}
		}
	}
