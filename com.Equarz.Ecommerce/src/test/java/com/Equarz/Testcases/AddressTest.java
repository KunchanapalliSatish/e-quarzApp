...
public class AddressTest extends Testbase {
	...
	public void address1(String personname1, String phonenumber1, String cityname1, String pincode1,
			String addressofperson1) throws Throwable {
		Af.Addressselection(personname1, phonenumber1, cityname1, pincode1, addressofperson1);
	}

	@Test(priority = 2, dataProvider = "setdata2", dataProviderClass = AddressTest.class)
	public void editing(String personname2, String phonenumber2, String cityname2, String pincode2,
			String addressofperson2) throws Throwable {
		Af.editaddress(personname2, phonenumber2, cityname2, pincode2, addressofperson2);
	}
